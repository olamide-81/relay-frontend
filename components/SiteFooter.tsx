...
/**
 * Landing-page footer. Hash links point at homepage sections so they
 * still resolve when rendered on /reports and other routes.
 */
        ...
        <div className="footer-top">
          ...
          <nav className="footer-links">
            <div>
              ...
              <Link href="/#intros">{t('footer.introductions')}</Link>
            ...
            <div>
              ...
              <Link href="/#directory">{t('footer.compliance')}</Link>
            </div>
            <div>
